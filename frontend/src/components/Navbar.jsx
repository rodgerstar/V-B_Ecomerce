        ...
        <div className= 'flex items-center justify-between py-5 font-medium'>
            ...
            className='flex items-center gap-6'>
                ...
                className='relative group'>
                    <Link to='/login'><img
                        className='w-5 cursor-pointer'
                        src={assets.profile_icon} alt=""/></Link>
                    <div
                    className='group-hover:block hidden absolute dropdown-menu right-0 pt4'>
                        <div
            ...
            className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                    ...
                    className='flex flex-col text-gray-600'>
                        ...
                        className='flex items-center gap-4 p-3 cursor-pointer mt-3 text-2xl'>
                            <img
                                className='h-5 rotate-180' src={assets.dropdown_icon} alt=""/>
                            <p className='text-lg'
                            >Back</p>
                        </div>
