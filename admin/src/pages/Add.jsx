...
const Add = ({token}) => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            formData.append("bestsellers", bestsellers ? "true" : "false");
    ...
    return (
        <form className='flex flex-col w-full items-start gap-3' onSubmit={onSubmitHandler}>
            ...
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <input onChange={(e) => setPrice(e.target.value)} value={price}
                           className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='99'/>
                </div>
            </div>
            ...
            <div className='flex gap-2 mt-2'>
                ...
                />
                <label className="cursor-pointer" htmlFor="bestsellers">Add to Bestseller</label>
            </div>
